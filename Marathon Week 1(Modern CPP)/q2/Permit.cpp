...
Permit::Permit(std::string serialNumber, TypeOfPermit type, int duration, float renewalCharge)
:_serial_number(serialNumber),_permit_type(type),_permit_duration_left(duration),_permit_renewal_charge(renewalCharge)
{
}
